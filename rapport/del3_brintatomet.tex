...
\begin{equation}
  ...
  \label{eq:rAfR}
\end{equation}
Dette giver anledning til en sammenligning mellem \cfef{eq:eksatR} og \cref{eq:rAfR}. Det ses at vi i begge udtryk har to led: et polynomielt led og et eksponentielt led. WKB approksimationen har dog taget højde for kvantetallet $l$ hvilket den eksakte løsning ikke har, hvilket ses
