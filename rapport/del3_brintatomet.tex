...
\begin{align}
  k(r) = & \frac{p(r)}{\hbar}\\
       = & \frac{\sqrt{\varepsilon}}{a_0}\frac{1}{r}\sqrt{(r-a)(r-b)}
\end{align}
...
\begin{align}
  n' = & \frac{\sqrt{\varepsilon}}{2a_0}(\sqrt{b}-\sqrt{a})^2\\
     = & \frac{\sqrt{\varepsilon}}{2a_0}(b+a-2\sqrt{ab})\\
...
\end{equation}
Og hvis vi husker på at $E = -\varepsilon Ry$, så kan vi skrives
\begin{equation}
...
For at finde dem i WKB tilfældet kigger vi allerførst på formen af en sådan bølgefunktion. Det kan vises at den er på formen %TODO find formen her
\begin{equation}
...
\begin{align}
  k(r) = & \frac{\sqrt{\varepsilon}}{a_0}\sqrt{(1-\frac{a}{r})(1-\frac{b}{r})}\\
       = & \frac{\sqrt{\varepsilon}}{a_0}\sqrt{1-\frac{a+b}{r}+\frac{ab}{r^2}}
\end{align}
...
\begin{equation}
  u(r) \sim e^{\left[\frac{1-\frac{r}{a_0}}{n'+\sqrt{l(l+1)}}\right]}{\left(\frac{r}{a_0}\right)}^{\left[n'+\sqrt{l(l+1)}\right]}
\end{equation}
